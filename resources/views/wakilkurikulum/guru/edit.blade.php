...
<div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg"> 
    ...
    <form method="post" action="{{ route('wakilkurikulum.guru.update', $guru->id) }}" class="mt-6 space-y-6">
        @csrf
        @method('put')
        ...
        <div class="flex space-x-6 justify-end">
            <div class="justify-center mb-4 md:w-1/2">
                <x-cancel-button class="bg-whiteColo py-2 px-4 rounded" onclick="window.history.back()">
                        {{ __('Batal') }}
                </x-cancel-button>
            </div>
            <div class="justify-center mb-4 md:w-1/2">
